...
(function () {
  const STR = {
    en: {
      ...
      noNutritionHint: "No nutrition data — this dish isn't linked to a recipe, or its recipe is missing grams/macros. It's not counted in the day's calories.",
      ...
      myCompany: "My company infos", companyOfficial: "Official company name", companyTrading: "Trading name", companyRep: "Representative name",
      companyInfoIntro: "These details were set by your administrator. Contact them if anything needs changing.", companyInfoEmpty: "Your administrator hasn't added your company details yet.",
      myPlaces: "My place(s)", renamePlaceIntro: "Rename your catering place(s). This only changes the name shown in the app.",
      ...
      wsAccess: "Workspace access", wsSeparate: "New private workspace", wsShare: "Share an existing user's workspace", wsShareWith: "Share with", wsShareHint: "This new email will see & edit the same data as the chosen user.",
      companyName: "Company", lastLogin: "Last login", never: "Never", sortHint: "Click a column header to sort.",
      linkedEmails: "Shared access — linked emails", linkedEmailsHint: "All these emails sign in to the SAME workspace and data.", primaryAccount: "Primary", addEmail: "Add email",
      removeAccess: "Remove access", removeAccessWarn: "Remove access for {e}? The login is deleted; the workspace data is kept.", accessRemoved: "Access removed", deleteFailed: "Could not remove access", cannotDeleteSelf: "You can't remove your own access",
      viewHistory: "View history", history: "History", historyHint: "Actions by this user over the last 3 months.", noHistory: "No activity in the last 3 months.",
      when: "When", actionCol: "Action", itemCol: "Item", actCreate: "Created", actUpdate: "Edited", actDelete: "Deleted", actLogin: "Signed in", actGenerate: "Generated menu",
    ...
    zh: {
      ...
      noNutritionHint: "無營養資料 — 此菜色未連結食譜，或其食譜缺少公克數／營養值，因此未計入當日熱量。",
      ...
      myCompany: "我的公司資料", companyOfficial: "公司正式名稱", companyTrading: "營業名稱", companyRep: "代表人姓名",
      companyInfoIntro: "以下資料由您的管理員設定。如需變更請與管理員聯絡。", companyInfoEmpty: "您的管理員尚未填寫公司資料。",
      myPlaces: "我的據點", renamePlaceIntro: "重新命名您的外燴據點。這只會變更應用程式中顯示的名稱。",
      ...
      wsAccess: "工作區存取", wsSeparate: "新的獨立工作區", wsShare: "共用現有用戶的工作區", wsShareWith: "共用對象", wsShareHint: "此新電子郵件將與所選用戶看到並編輯相同的資料。",
      companyName: "公司", lastLogin: "上次登入", never: "從未", sortHint: "點按欄位標題可排序。",
      linkedEmails: "共享存取 — 連結的電子郵件", linkedEmailsHint: "這些電子郵件都登入到同一個工作區與資料。", primaryAccount: "主帳號", addEmail: "新增電子郵件",
      removeAccess: "移除存取權", removeAccessWarn: "移除 {e} 的存取權？將刪除此登入帳號，但保留工作區資料。", accessRemoved: "已移除存取權", deleteFailed: "無法移除存取權", cannotDeleteSelf: "無法移除自己的存取權",
      viewHistory: "檢視紀錄", history: "操作紀錄", historyHint: "此用戶最近三個月的操作。", noHistory: "最近三個月沒有操作紀錄。",
      when: "時間", actionCol: "操作", itemCol: "項目", actCreate: "新增", actUpdate: "編輯", actDelete: "刪除", actLogin: "登入", actGenerate: "產生菜單",
